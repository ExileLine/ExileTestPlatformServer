...
docker run -v /srv/ExileTestPlatformServer/app/static/report:/srv/ExileTestPlatformServer/app/static/report /srv/ExileTestPlatformServer/app/static/UiRecorderProject:/srv/UiRecorderProject -d --network host --name exile_platform exile_platform
