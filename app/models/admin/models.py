...
class Admin(BaseModel):
    __tablename__ = 'exilic_auth_admin'
...
class Role(BaseModel):
    __tablename__ = 'exilic_auth_role'
...
class Permission(BaseModel):
    __tablename__ = 'exilic_auth_permission'
...
class MidAdminAndRole(BaseModel):
    __tablename__ = 'exilic_auth_mid_admin_role'
    __table_args__ = (
...
class MidPermissionAndRole(BaseModel):
    __tablename__ = 'exilic_auth_mid_permission_role'
    __table_args__ = (
...
class ApiResource(BaseModel):
    __tablename__ = 'exilic_auth_api_resource'
...
class RouteResource(BaseModel):
    __tablename__ = 'exilic_auth_route_resource'
